...
class Title:
    ...
    def update_title(self):
            try:
                ...
                title = f'Snepiaty Gen | G: {genned} | E: {errors} | S: {solved} | U: {unlocked} | L: {locked} | Unlock Rate: {unlock_rate}% | Elapsed: {round(time() - genStartTime, 2)}s |'
...
class Log:
    ...
    @staticmethod
    def Success(message, prefix=f"{Fore.LIGHTMAGENTA_EX}[{Fore.RESET}+{Fore.LIGHTMAGENTA_EX}]{Fore.RESET}"):
        Log._log("SUCCESS", f"{prefix}{Fore.RESET}", message)

    @staticmethod
    def Error(message, prefix=f"{Fore.LIGHTMAGENTA_EX}[{Fore.RESET}-{Fore.LIGHTMAGENTA_EX}]{Fore.RESET}"):
        Log._log("ERROR", f"{prefix}{Fore.RESET}", message)

    @staticmethod
    def Debug(message, prefix=f"{Fore.LIGHTMAGENTA_EX}[{Fore.RESET}*{Fore.LIGHTMAGENTA_EX}]{Fore.RESET}"):
        Log._log("DEBUG", f"{prefix}{Fore.RESET}", message)

    @staticmethod
    def Solved(message, prefix=f"{Fore.LIGHTMAGENTA_EX}[{Fore.RESET}!{Fore.LIGHTMAGENTA_EX}]{Fore.RESET}"):
        Log._log("SOLVED", f"{prefix}{Fore.RESET}", message)

    @staticmethod
    def Info(message, prefix=f"{Fore.LIGHTMAGENTA_EX}[{Fore.RESET}?{Fore.LIGHTMAGENTA_EX}]{Fore.RESET}"):
        Log._log("INFO", f"{prefix}{Fore.RESET}", message)

    @staticmethod
    def Warning(message, prefix=f"{Fore.RED}[{Fore.RESET}!{Fore.RED}]{Fore.RESET}"):
        Log._log("WARNING", f"{prefix}{Fore.RESET}", message)
...
$$  _____|                    $$ |      \__|                                                   \__|                    
$$ |       $$$$$$\  $$$$$$$\  $$ |  $$\ $$\  $$$$$$$\  $$$$$$$\  $$$$$$\   $$$$$$\  $$\    $$\ $$\  $$$$$$$\  $$$$$$\  
$$$$$\     \____$$\ $$  __$$\ $$ | $$  |$$ |$$  _____|$$  _____|$$  __$$\ $$  __$$\ \$$\  $$  |$$ |$$  _____|$$  __$$\ 
$$  __|    $$$$$$$ |$$ |  $$ |$$$$$$  / $$ |\$$$$$$\  \$$$$$$\  $$$$$$$$ |$$ |  \__| \$$\$$  / $$ |$$ /      $$$$$$$$ |
$$ |      $$  __$$ |$$ |  $$ |$$  _$$<  $$ | \____$$\  \____$$\ $$   ____|$$ |        \$$$  /  $$ |$$ |      $$   ____|
$$ |      \$$$$$$$ |$$ |  $$ |$$ | \$$\ $$ |$$$$$$$  |$$$$$$$  |\$$$$$$$\ $$ |         \$  /   $$ |\$$$$$$$\ \$$$$$$$\ 
\__|       \_______|\__|  \__|\__|  \__|\__|\_______/ \_______/  \_______|\__|          \_/    \__| \_______| \_______|

    ''')
    threads = int(input(Fore.RED + "Threadcount: " + Fore.RESET))
